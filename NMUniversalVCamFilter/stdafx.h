...
#define TEMPLATE_NAME	(L"Virtual Caption Camera")
#define FILTER_NAME		(TEMPLATE_NAME)
#define OUTPUT_PIN_NAME (L"Output")
#define TARGET_WINDOW_NAME (L"[VirtualCaptionCam]")
...
#include <Windows.Graphics.Capture.Interop.h> // IGraphicsCaptureItem, IGraphicsCaptureItemInterop で必要
#include <windows.h>
